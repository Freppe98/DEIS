...
try:
    ...
    # Fallback to smbus if smbus2 isn't installed
    from smbus import SMBus

INA260_I2C_ADDR = 0x41  # 0x40 Default address, change if altered A0/A1 (yes A0 soldered)
...
# ---- Simple global wrapper API (what you asked for) ----

_ina260_thread = None

def startINA260(bus_num=1, address=INA260_I2C_ADDR, interval=0.2):
    """Start background INA260 reader thread."""
...
def stopINA260():
    """Stop background INA260 reader thread."""
    global _ina260_thread
...
if __name__ == "__main__":
    ...
    # Adjust bus_num/address if needed
